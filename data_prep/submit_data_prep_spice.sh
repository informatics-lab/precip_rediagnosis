...
echo writing data to ${OUTPUT_PATH}
...
sbatch --job-name ${PRD_JOB_NAME} --output ${PRD_LOG_OUT_PATH} --error ${PRD_LOG_ERR_PATH} --export="EVENT_NAME,OUTPUT_PATH" data_prep/run_data_prep_spice.sh
